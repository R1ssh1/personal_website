    ...
    return (
        ...
        >
            <Link href={`/projects/${displayProject.slug}`}>
                <div
                    className="h-full flex flex-col glass-morphism rounded-xl overflow-hidden border border-white/10 hover:border-white/20 transition-all duration-300"
                        ...
                        <div className="flex gap-3 mt-auto">
                            {displayProject.github && (
                                <button
                                    ...
                                    className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl text-white font-medium transition-all duration-300 hover:scale-105"
                                >
                            ...
                            {displayProject.demo && (
                                <button
                                    ...
                                    className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-sky-500/20 hover:bg-sky-500/30 border border-sky-500/30 rounded-xl text-sky-400 font-medium transition-all duration-300 hover:scale-105"
                                >
