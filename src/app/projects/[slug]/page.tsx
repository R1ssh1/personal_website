                ...
                <div className="glass-morphism rounded-2xl p-8 border border-white/10">
                    ...
                    <header className="mb-8">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            {project.featured && (
                                <span className="px-3 py-1 text-sm font-medium bg-blue-500/20 border border-blue-500/30 text-blue-400 rounded-full">
                                    Featured
                                </span>
                            )}
                        </div>
                        ...
                        <p className="text-xl text-white/70 mb-6">
                            {project.summary.replace(/<[^>]*>/g, '').replace(/&[a-z]+;/gi, ' ').replace(/\s+/g, ' ').trim()}
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-6">
                            {project.githubUrl && (
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl text-white font-medium transition-all duration-300"
                                >
                            ...
                            {project.demoUrl && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-2 px-4 py-2 bg-sky-500/20 hover:bg-sky-500/30 border border-sky-500/30 rounded-xl text-sky-400 font-medium transition-all duration-300"
                                >
