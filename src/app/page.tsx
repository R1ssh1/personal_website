...
export default function Home() {
  return (
    <div className="min-h-screen relative">
      ...
      {/* Quick Links Section */}
      <section className="relative z-20 py-16 px-4 max-w-[1400px] mx-auto -mt-16">
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4 md:gap-8">
          <Link href="/about" className="group">
            <GlareHover intensity="medium" className="flex flex-col items-center text-center glass-morphism p-6 rounded-xl group-hover:bg-accent/10 transition-all duration-150">
          ...
          <Link href="/contact" className="group">
            <GlareHover intensity="medium" className="flex flex-col items-center text-center glass-morphism p-6 rounded-xl group-hover:bg-accent/10 transition-all duration-150">
              ...
              <h3 className="text-xl font-semibold mb-3 text-text group-hover:text-accent transition-colors">Contact</h3>
              <p className="text-muted text-sm leading-relaxed">
